...
Server.prototype.startServer = function() {
	...
	try{
		...
		if(fs.existsSync('node_modules/simpleportal/default_/resources/public'))
			instance.server.use(require('connect').static('node_modules/simpleportal/default_/resources/public'));
...
Server.prototype.use = function(module){
	...
	if(module == simpleportal.db){
		...
		instance.on('db.init', function(){
			...
			simpleportal.services.updateConfiguration(instance.configuration);
		});
	} else{ 
		simpleportal.util.callModuleFunction(module, true, 'init', instance.configuration);	
	}
