...
Service.prototype.validation_ = {
	...
	url:function(value){
		...
		//console.log(value.search(urlPattern))
	...
	if(instance.dataformat){
		for(format in instance.dataformat){
			if(format == 'object'){
				...
				object[format] = instance.dataformat[format](object[format], object[format], request.body);
		}
		if(instance.dataformat.hasOwnProperty('object')){
			object = instance.dataformat['object'](object, request.body);
		}
	}
	...
	if(instance.model){
		for(field in instance.model){
			if(typeof instance.model[field] == 'boolean')
				object[field] = instance.dataformat_.boolean(object[field], instance.model[field], request.body);
			else if(typeof instance.model[field] == 'array')
				object[field] =  instance.dataformat_.array(object[field], instance.model[field], request.body);
        	...
        	if(instance.dbid && instance.collection) {
                ...
                if(instance.modify){
                	if(instance.dbid && instance.collection){
                		...
                		instance.post('/:id', function(request, response, callback) {
    	                	var options = instance.dbmodeloptions;
    	            		if(request.dbid)
    	            			options.dbid = request.dbid;
