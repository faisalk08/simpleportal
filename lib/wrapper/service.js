...
Service.prototype.dataformat_ = {
	...
	array: function(value, defaultValue){
		if(!value)
			return defaultValue||[];
...
Service.prototype.getObject = function(request){
	...
	if(instance.dataformat){
		for(format in instance.dataformat){
			if(object[format])
				object[format] = instance.dataformat[format](object[format]);
		}
	}
	...
	if(instance.model){
		for(field in instance.model){
			if(typeof instance.model[field] == 'boolean')
				object[field] = instance.dataformat_.boolean(object[field]);
			else if(typeof instance.model[field] == 'array')
				object[field] =  instance.dataformat_.array(object[field]);
