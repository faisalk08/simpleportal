...
//	
	updateTemporaryTemplateHandler(instance, instance.viewUrl + "/" + instance.systemServiceUrl)
	updateTemporaryTemplateHandler(instance, instance.viewUrl)
...
function updateTemporaryTemplateHandler(instance, viewurl, callback){
	var urls = {};
